...
import 'schema/bankbalance_record.dart';
import 'schema/transaction_record.dart';
import 'schema/posts_record.dart';
import 'schema/postreplies_record.dart';
...
export 'schema/bankbalance_record.dart';
export 'schema/transaction_record.dart';
export 'schema/posts_record.dart';
export 'schema/postreplies_record.dart';
...
/// Functions to query BankbalanceRecords (as a Stream and as a Future).
Future<int> queryBankbalanceRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BankbalanceRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BankbalanceRecord>> queryBankbalanceRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BankbalanceRecord.collection,
      BankbalanceRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BankbalanceRecord>> queryBankbalanceRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<BankbalanceRecord>> queryBankbalanceRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query PostrepliesRecords (as a Stream and as a Future).
Future<int> queryPostrepliesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PostrepliesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PostrepliesRecord>> queryPostrepliesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PostrepliesRecord.collection,
      PostrepliesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PostrepliesRecord>> queryPostrepliesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<PostrepliesRecord>> queryPostrepliesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
