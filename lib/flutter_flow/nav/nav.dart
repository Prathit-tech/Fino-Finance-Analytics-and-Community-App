          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'myTransactions')
            ...
            FFRoute(
              ...
              builder: (context, params) => TaskDetailsWidget(
                ...
                transref: params.getParam('transref',
            ...
            FFRoute(
              ...
              path: 'fincontent',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'fincontent')
                  : FincontentWidget(),
            ),
            FFRoute(
              name: 'yourposts',
              path: 'yourposts',
              builder: (context, params) => YourpostsWidget(),
            )
